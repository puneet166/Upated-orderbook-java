...
public class UserManager {
    ...
    public User createUser(String userId) {
        ...
        if (user != null) {
            // System.out.println("Creating 29 new user with userId: " + userId);

            throw new RuntimeException("duplicate userId");
        }
        ...
        // create new user
        user = new User();
        // System.out.println("Creating 38 new user with userId: " + user);
        user.setCreatedAt(new Date());

        user.setId(userId);
        // System.out.println("Creating 37 new user with userId: " + user);

        // logger.info("Creating new 37 line no user with userId: {}", userId);
        ...
        // user.setRole(false);
        // }
                // System.out.println("Creating 54 new user with userId: " + user);

        // logger.info("Creating new 48 line no user with userId: {}", userId);
                // System.out.println("Creating 51 new user with userId: " + user);

        userRepository.save(user);
        // logger.info("Creating new 51 line no user with userId: {}", userId);
                // System.out.println("Creating 55 new user with userId: " + userId);
